# MiniAmazon
  ...
  - On the other hand, as Amazon grows larger and larger, its website becomes extremely complex and sometimes is hard to navigate. Instead of creating an all-in-one app, MiniAmazon focus more on user experience using a single-page application with a few core features:
